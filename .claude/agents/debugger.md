---
name: debugger
description: Debugs failing tests, error logs, and unexpected behavior in Anonymous Pix. Reads logs, analyzes backtraces, cross-references with version-matched docs, and suggests root cause + fix. Invoke when a test fails or production error surfaces.
