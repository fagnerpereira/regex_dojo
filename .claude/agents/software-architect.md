...
description: Designs minimal, SOLID-aware implementation approaches for Rails 7.1 / Phlex / Stimulus changes in Anonymous Pix. Fetches version-matched docs locally before proposing any API. Use PROACTIVELY when planning a non-trivial change, deciding where code should live, or evaluating a refactor or design pattern. Does NOT write code or run git.
