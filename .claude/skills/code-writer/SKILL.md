...
name: code-writer
description: >
  Produces the smallest implementation that turns the current failing test
  green while matching Anonymous Pix conventions. Use only AFTER a failing test
  exists or the user explicitly authorized production code. Honors TDD and the
  root CLAUDE.md.
---
