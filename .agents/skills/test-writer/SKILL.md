...
name: test-writer
description: >
  Writes the FIRST failing test (TDD red phase) for any feature or bug fix in
  Anonymous Pix. Specializes in request specs, system specs, Phlex component
  specs, and model specs. Invoke before any production code is written.
---
